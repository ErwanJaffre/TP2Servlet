     ...
     */
       protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ShowStateSelection</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ShowStateSelection at " + request.getContextPath() + "</h1>");
            
            try{
                out.println("<form action='stateCustomers'>");
                out.println("<select id='state' name='state'>");
                out.println("<option>Etat</option>");
                for(String s:dao.listeEtats()){
